            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="table-responsive" id="tabel_ket_demografi">
                        {!! form_open(ci_route('dtsen/pendataan/save') . '/' . $dtks->id, 'class="form-4 form-validasi" id="form-4-demografi"') !!}
                    ...
                    <div class="table-responsive" id="tabel_pendidikan">
                        {!! form_open(ci_route('dtsen/pendataan/save') . '/' . $dtks->id, 'class="form-4 form-validasi" id="form-4-pendidikan"') !!}
                    ...
                    <div class="table-responsive" id="tabel_ketenagakerjaan">
                        {!! form_open(ci_route('dtsen/pendataan/save') . '/' . $dtks->id, 'class="form-4 form-validasi" id="form-4-ketenagakerjaan"') !!}
                    ...
                    <div class="table-responsive" id="tabel_kepemilikan_usaha">
                        {!! form_open(ci_route('dtsen/pendataan/save') . '/' . $dtks->id, 'class="form-4 form-validasi" id="form-4-kepemilikan-usaha"') !!}
                    ...
                    <div class="table-responsive" id="tabel_kesehatan">
                        {!! form_open(ci_route('dtsen/pendataan/save') . '/' . $dtks->id, 'class="form-4 form-validasi" id="form-4-kesehatan"') !!}
                    ...
                    <div class="table-responsive" id="tabel_program_perlindungan_sosial">
                        {!! form_open(ci_route('dtsen/pendataan/save') . '/' . $dtks->id, 'class="form-4 form-validasi" id="form-4-program-perlindungan-sosial"') !!}
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.form-4').on('submit', function(ev) {
                ...
                ajax_save_dtks("{{ ci_route('dtsen/pendataan/save') . '/' . $dtks->id }}", form, callback_success);
            });
        });
    </script>
@endpush
