...
<head>
    ...
    <link href="{{ asset('lib/anjungan/css/color/travel.css') }}" rel="stylesheet alternate" title="travel" />
    <link href="{{ asset('lib/anjungan/css/color/casual.css') }}" rel="stylesheet alternate" title="casual" />
    <link href="{{ asset('lib/anjungan/css/darkmode.css') }}" rel="stylesheet">
    <link href="{{ asset('lib/anjungan/css/style.css') }}" rel="stylesheet">
    <link href="{{ asset('lib/anjungan/css/screen.css') }}" rel="stylesheet">
    @stack('css')
    ...
    <div class="full-container" id="element">
        ...
        <div class="anjungan-head plr-master difle-l">
            ...
            <div class="topright difle-l">
                <a class="topright-icon radius-4 popup" title="Kehadiran Perangkat Desa" data-value="./kehadiran"><img src="{{ asset('lib/anjungan/images/icon/absen.png') }}">
                    <p>Absen</p>
                </a>
                <a class="topright-icon radius-4" href="./buku-tamu"><img src="{{ asset('lib/anjungan/images/icon/bukutamu.png') }}">
                    <p>Buku<br />Tamu</p>
                </a>
                <?php $pemerintah = explode(' ', ucwords(setting('sebutan_pemerintah_desa'))); ?>
                <a class="topright-icon radius-4" data-bs-toggle="modal" data-bs-target="#aparatur"><img src="{{ asset('lib/anjungan/images/icon/aparatur.png') }}">
                    <p><?= $pemerintah[0] ?><br /><?= $pemerintah[1] ?></p>
                </a>
                <a class="topright-icon radius-4 popup" data-value="./layanan-mandiri/masuk"><img src="{{ asset('lib/anjungan/images/icon/mandiri.png') }}">
                    <p>Layanan<br />Mandiri</p>
                </a>
                <div style="position:relative;">
                    <div class="topright-icon radius-4" data-bs-toggle="dropdown">
                        <div><img src="{{ asset('lib/anjungan/images/icon/warna.png') }}">
                            <p>Pilih<br />Warna</p>
                        </div>
                    </div>
                    <div class="dropdown-menu colorstyle" role="menu">
                        ...
                        <div class="darklight difle-l" onclick="setDarkMode(true)" id="darkBtn">
                            <div class="darklight-icon radius-4 difle-c"><img src="{{ asset('lib/anjungan/images/icon/dark.png') }}"></div>
                            <p>Gelapkan Layar</p>
                        </div>
                    </div>
                </div>
                <div class="topright-icon iconhid radius-4" id="openfull" onclick="openFullscreen();">
                    <div><img src="{{ asset('lib/anjungan/images/icon/maximize.png') }}">
                        <p>Full<br />Screen</p>
                    </div>
                </div>
                <div class="topright-icon iconhid radius-4" id="exitfull" onclick="closeFullscreen();">
                    <div><img src="{{ asset('lib/anjungan/images/icon/minimize.png') }}">
...
<script>
    var light = '{{ asset('lib/anjungan/images/icon/light.png') }}';
    var dark = '{{ asset('lib/anjungan/images/icon/dark.png') }}';
</script>

<script src="{{ asset('lib/anjungan/js/support.js') }}"></script>
