<form id="validasi" action="{{ $form_action }}" method="POST" enctype="multipart/form-data">
    <div class='modal-body'>
        ...
        <p class="help-block small">1. Data yang dibutuhkan untuk Impor dengan memenuhi aturan data sebagai berikut <a href="{{ asset_impor('analisis.xlsx') }}">Aturan Data</a></p>
        <p class="help-block small">2. Contoh format upload Sensus dapat dilihat pada tautan berikut <a href="{{ asset_impor('ppls2.xlsx') }}">Contoh</a></p>
