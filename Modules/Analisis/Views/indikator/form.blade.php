...
@push('scripts')
    <script type="text/javascript">
        ...
        function reset_form() {
            // Set Aksi Analisis
            let actAnalisis = "{{ $analisis_indikator['act_analisis'] ?? 2 }}"; // default 2 (Tidak)
            if (actAnalisis == '1') {
            ...
            // Set Publikasi
            let publik = "{{ $analisis_indikator['is_publik'] ?? 0 }}"; // default 0 (Tidak)
            if (publik == '1') {
            ...
            // Set tipe pertanyaan
            let tipe = "{{ $analisis_indikator['id_tipe'] ?? 1 }}"; // default 1
            checked(tipe);
