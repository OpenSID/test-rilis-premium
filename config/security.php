...
return [
    ...
    'headers' => [
        ...
        'Content-Security-Policy' => "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: *.jsdelivr.net *.cloudflare.com code.jquery.com cdn.ckeditor.com unpkg.com uicdn.toast.com toast.com *.googleapis.com *.github.io *.facebook.net platform.twitter.com cdn.datatables.net www.google.com www.gstatic.com; worker-src 'self' blob:; child-src 'self' blob:; style-src 'self' 'unsafe-inline' fonts.googleapis.com *.gstatic.com *.jsdelivr.net *.cloudflare.com unpkg.com uicdn.toast.com toast.com cdn.datatables.net; img-src 'self' data: *; font-src 'self' data: fonts.gstatic.com *.cloudflare.com *.jsdelivr.net; connect-src 'self' api.ipify.org *.cloudflare.com unpkg.com api.mapbox.com *.mapbox.com www.google.com www.gstatic.com; frame-src 'self' data: *.google.com www.google.com www.gstatic.com; frame-ancestors 'self'; object-src 'self' blob:; base-uri 'self';",
