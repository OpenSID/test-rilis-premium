                            ...
                            <ol>
                                ...
                                <li>Data yang dibutuhkan untuk Impor dengan memenuhi urutan format dan aturan data pada tautan
                                    ...
                                    <div class="timeline-footer col-sm-12">
                                        <a href="{{ asset_impor('FormatImporExcel.xlsm') }}" class="btn btn-social btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block margin" wrap><i class="fa fa-download"></i> Aturan dan Contoh Format Data</a>
                                        <a href="{{ asset_impor('contoh_penduduk.xlsx') }}" class="btn btn-social btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block margin" wrap><i class="fa fa-download"></i> Contoh Data Penduduk Ekspor</a>
                                    </div>
                                </li>
                            </ol>
                        </div>
