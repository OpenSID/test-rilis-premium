                ...
                <form id="mainform" action="{{ ci_route('rtm.impor') }}" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <br />
                            <br />
                            <a href="{{ asset_impor('FormatImporRTM.xlsx') }}" class="btn btn-social bg-purple btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block text-center"><i class="fa fa-file-excel-o"></i> Contoh Format Impor Data Rumah Tangga</a>
                        </div>
                    </div>
