                                ...
                                <tr>
                                    ...
                                    >
                                        ...
                                        <p
                                            ...
                                            Silakan klik tombol di bawah ini untuk mengaktifkan verifikasi Two-Factor Authentication (2FA).</p>
                                        <table
                                            class="action"
                                            align="center"
                                            width="100%"
                                                                ...
                                                                >
                                                                    <tr>
                                                                        <td style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                                                            <a href="{{ site_url("pengguna/verifikasi_aktifkan_2fa/{$hash}?signature={$signature}&expires={$expire}") }}" class="button button-primary" target="_blank" rel="noopener"
                                                                            ...
                                                                            >Aktifkan verifikasi Two-Factor Authentication (2FA)</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                            ...
                                            <tr>
                                                <td style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative;">
                                                    <p
                                                        ...
                                                        Jika Anda kesulitan mengklik tombol "Aktifkan verifikasi Two-Factor Authentication (2FA)", salin dan tempel URL di bawah ini
                                                        ...
                                                        ><a href="{{ site_url("pengguna/verifikasi_aktifkan_2fa/{$hash}?signature={$signature}&expires={$expire}") }}"
                                                            ...
                                                            >{{ site_url("pengguna/verifikasi_aktifkan_2fa/{$hash}?signature={$signature}&expires={$expire}") }}</a></span></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
