                        ...
                        @foreach ( $syarat_permohonan as $key => $syarat )
                            <tr>
                                ...
                                <td class="padat">
                                    ...
                                    @else
                                        <a href="{{ ci_route('permohonan_surat_admin.tampilkan',"{$syarat['dok_id']}/{$periksa['id_pemohon']}" ) }}" class="btn btn-social btn-flat btn-info btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Tampilkan" data-target="#modalBox" data-remote="false" data-toggle="modal" data-backdrop="false" data-keyboard="false" data-title="Tampilkan Dokumen"><i class="fa fa-eye"></i> Cek Dokumen</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
