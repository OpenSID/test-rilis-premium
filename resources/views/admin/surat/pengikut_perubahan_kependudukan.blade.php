        ...
        <div>
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover tabel-daftar">
                    ...
                    <tbody>
                        @foreach ($pengikut_perubahan_kependudukan as $key => $data)
                            <tr>
                                <td class="padat">
                                    <input type="checkbox" name="id_pengikut_perubahan_kependudukan[]" value="{{ $data->id }}" onchange="pilihAnggota(this)" />
                                </td>
...
<div class="form-group subtitle_head">
    <label class="col-sm-3 control-label"><strong>DATA KELUARGA</strong></label>
</div>
