...
class Covid19_model extends MY_Model
{
    ...
    public function get_penduduk_by_id($id)
    {
        ...
        $this->db->select('u.id, u.nama, x.nama AS sex, u.agama_id, u.warganegara_id, u.id_kk, u.tempatlahir, u.tanggallahir, d.nama AS pendidikan, u.nik, c.rt, c.rw, c.dusun, k.no_kk, k.alamat');
