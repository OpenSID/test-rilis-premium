...
class Migrasi_rev
{
    ...
    {
        log_message('notice', 'Migrasi: Update URL Arsip Surat Dinas');
    ...
    public function hapusTabelKeuangan()
    {
        ...
        log_message('notice', 'Migrasi: Tabel Keuangan telah dihapus.');
        DB::statement('SET FOREIGN_KEY_CHECKS=1');
    }

    public function updatePengaturanSurat()
    {
        log_message('notice', 'Migrasi: Update Pengaturan Surat');
    ...
    public function updateRestrictFkNew()
    {
        ...
        log_message('notice', 'Migrasi: Restrict Foreign Key telah diperbarui.');
    }
    ...
    public function tambahPengaturanDTKS()
    {
        ...
        log_message('notice', 'Migrasi: Pengaturan DTKS telah ditambahkan.');
    }

    public function replaceViewPendudukHidup()
    {
        log_message('notice', 'Migrasi: Mengganti View Penduduk Hidup');
        // Penduduk Hidup
    ...
    {
        log_message('notice', 'Migrasi: Membuat Tabel Profil Desa');
