...
,
    ...
    public function list_data_map()
    {
        ...
        $this->db
            ->select("u.id, u.nik, u.nama, u.sex as id_sex, u.id_kk, map.lat, map.lng, a.dusun, a.rw, a.rt, u.foto, d.no_kk AS no_kk,
                DATE_FORMAT(FROM_DAYS(TO_DAYS(NOW())-TO_DAYS(`tanggallahir`)), '%Y')+0	AS umur, x.nama AS sex, sd.nama AS pendidikan_sedang, n.nama AS pendidikan, m.nama AS gol_darah, hub.nama AS hubungan,
    ...
    public function get_penduduk($id = 0, $nik_sementara = false)
    {
        $sql = "SELECT bahasa.nama as bahasa_nama, u.sex as id_sex, u.*, a.dusun, a.rw, a.rt, t.id AS id_status, t.nama AS status, o.nama AS pendidikan_sedang, m.nama as golongan_darah, h.nama as hubungan,
            ...
            x.nama AS sex, c.nama as cacat, kb.nama as cara_kb, sm.nama as sakit_menahun, sd.nama as status_dasar, u.status_dasar as status_dasar_id,
    ...
    public function get_penduduk_by_nik($nik = 0)
    {
        ...
        from tweb_penduduk where (tweb_penduduk.id = u.id)) AS umur, h.nama as hubungan, d.nama AS pendidikan, u.nik AS nik, c.rt AS rt, c.rw AS rw, c.dusun AS dusun, k.no_kk AS no_kk, k.alamat,
