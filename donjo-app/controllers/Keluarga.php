...
class Keluarga extends Admin_Controller
{
    ...
    public function form_a($p = 1, $o = 0, $id = 0): void
    {
        ...
        // TODO:: ganti cara ini, gunakan where id dan status dasar
    ...
    public function delete($p = 1, $o = 0, $id = 0): void
    {
        ...
        if ($this->keluarga_model->cek_boleh_hapus($id)) {
            session_error('Data tidak dapat dihapus karena masih memiliki anggota keluarga');
        } else {
    ...
    public function update_anggota($p = 1, $o = 0, $id_kk = 0, $id = 0): void
    {
        isCan('u');
        // TODO:: ganti cara ini, gunakan where id dan status dasar
        if ($this->keluarga_model->get_kepala_a($id_kk)['status_dasar'] == 1) {
            show_404();
        }
