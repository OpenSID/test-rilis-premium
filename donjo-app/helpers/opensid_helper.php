...
// Desa
define('LOKASI_LOGO_DESA', FCPATH.'desa/logo/');
define('LOKASI_ARSIP', FCPATH.'desa/arsip/');
define('LOKASI_CONFIG_DESA', FCPATH.'desa/config/');
define('LOKASI_SURAT_SISTEM', 'template-surat/');
define('LOKASI_SURAT_DESA', FCPATH.'desa/template-surat/');
define('LOKASI_SURAT_FORM_DESA', FCPATH.'desa/template-surat/form/');
define('LOKASI_SURAT_PRINT_DESA', FCPATH.'desa/template-surat/print/');
define('LOKASI_SURAT_EXPORT_DESA', FCPATH.'desa/template-surat/export/');
define('LOKASI_USER_PICT', FCPATH.'desa/upload/user_pict/');
define('LOKASI_GALERI', FCPATH.'desa/upload/galeri/');
define('LOKASI_FOTO_ARTIKEL', FCPATH.'desa/upload/artikel/');
define('LOKASI_FOTO_LOKASI', FCPATH.'desa/upload/gis/lokasi/');
define('LOKASI_FOTO_AREA', FCPATH.'desa/upload/gis/area/');
define('LOKASI_FOTO_GARIS', FCPATH.'desa/upload/gis/garis/');
define('LOKASI_DOKUMEN', FCPATH.'desa/upload/dokumen/');
define('LOKASI_PENGESAHAN', FCPATH.'desa/upload/pengesahan/');
define('LOKASI_WIDGET', FCPATH.'desa/widgets/');
define('LOKASI_GAMBAR_WIDGET', FCPATH.'desa/upload/widgets/');
define('LOKASI_KEUANGAN_ZIP', FCPATH.'desa/upload/keuangan/');
define('LOKASI_MEDIA', FCPATH.'desa/upload/media/');
define('LOKASI_SIMBOL_LOKASI', FCPATH.'desa/upload/gis/lokasi/point/');
define('LOKASI_SINKRONISASI_ZIP', FCPATH.'desa/upload/sinkronisasi/');
define('LOKASI_PRODUK', FCPATH.'desa/upload/produk/');
define('LOKASI_PENGADUAN', FCPATH.'desa/upload/pengaduan/');
define('LOKASI_VAKSIN', FCPATH.'desa/upload/vaksin/');
define('LATAR_LOGIN', FCPATH.'desa/pengaturan/siteman/images/');
define('LATAR_KEHADIRAN', FCPATH.'desa/pengaturan/siteman/images/');
define('LOKASI_PENDAFTARAN', FCPATH.'desa/upload/pendaftaran');
