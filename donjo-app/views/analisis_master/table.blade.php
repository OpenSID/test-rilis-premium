															...
															<?php foreach ($main as $data) : ?>
																<tr>
																	...
																	<td nowrap>
																		...
																		<?php endif; ?>
																		<?php if ($data['jenis'] != 1 && $ci->CI->cek_hak_akses('u')) : ?>
																		...
																		<?php endif; ?>
																		<?php if ($data['gform_id'] != null && $data['gform_id'] != '' && $ci->CI->cek_hak_akses('u')) : ?>
...
<?php $ci->load->view('analisis_master/modal_pertanyaan', $data); ?>
<?php $ci->load->view('analisis_master/modal_jawaban_pilihan', $data); ?>
<?php $ci->load->view('analisis_master/modal_hasil_import', $data); ?>
