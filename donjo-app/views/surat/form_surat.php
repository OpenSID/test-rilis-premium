...
<?php
$nama_surat = $url;
$form_surat = PUBLICPATH . LOKASI_SURAT_DESA . $nama_surat . '/' . $nama_surat . '.php';
if (is_file($form_surat)) {
  include $form_surat;
} elseif (is_file(PUBLICPATH . LOKASI_SURAT_FORM_DESA . $nama_surat . '.php')) {
  include PUBLICPATH . LOKASI_SURAT_FORM_DESA . $nama_surat . '.php';
} else {
  include FCPATH . "template-surat/{$nama_surat}/{$nama_surat}.php";
}
?>
