...
<select class="form-control input-sm " name="dusun" onchange="formAction('<?= $form; ?>','<?= site_url("{$ci->controller}/filter/dusun"); ?>')">
...
<?php if ($dusun): ?>
	<select class="form-control input-sm" name="rw" onchange="formAction('<?= $form; ?>','<?= site_url("{$ci->controller}/filter/rw"); ?>')" >
...
<?php endif; ?>
<?php if ($rw): ?>
	<select class="form-control input-sm" name="rt" onchange="formAction('<?= $form; ?>','<?= site_url("{$ci->controller}/filter/rt"); ?>')">
