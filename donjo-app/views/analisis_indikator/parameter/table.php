	...
	<section class="content" id="maincontent">
		<form id="mainform" name="mainform" method="post">
            ...
            <div class="box-header with-border">
							<?php if ($ci->CI->cek_hak_akses('u') && ! $analisis_indikator['referensi']): ?>
							...
							<?php endif; ?>
							<?php if ($ci->CI->cek_hak_akses('h') && ! $analisis_indikator['referensi']): ?>
									...
									<div class="table-responsive">
										<table class="table table-bordered dataTable table-striped table-hover tabel-daftar">
											<thead class="bg-gray disabled color-palette">
												<tr>
													<?php if ($analisis_master['lock'] == 1 && $ci->CI->cek_hak_akses('u') && ! $analisis_indikator['referensi']): ?>
														<th><input type="checkbox" id="checkall"/></th>
													<?php endif; ?>
													<th>No</th>
													<?php if ($analisis_master['lock'] == 1 && $ci->CI->cek_hak_akses('u')): ?>
														<th>Aksi</th>
													<?php endif; ?>
													<th>Kode</th>
													<th>Jawaban</th>
