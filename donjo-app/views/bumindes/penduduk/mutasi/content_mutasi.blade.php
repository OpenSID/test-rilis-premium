						...
						<table class="table table-condensed table-bordered dataTable table-striped table-hover tabel-daftar">
							<thead class="bg-gray color-palette">
								<tr>
									...
									<th rowspan="2" style="width: 5px;"><?= url_order($o, "{$ci->controller}/{$func}/{$p}", 3, 'Nama Lengkap / Panggilan'); ?></th>
...
<?php else:
    ...
    $ci->load->view('bumindes/penduduk/rekapitulasi/data_lengkap', ['judul_rekap' => 'Buku Mutasi Penduduk']);
