...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Lembaran dan Berita <?=ucwords(setting('sebutan_desa'))?></title>
		...
		<div id="container">
			<div id="body">
				<div class="header" align="center">
					...
					<h4><?= strtoupper(setting('sebutan_desa') . ' ' . $desa['nama_desa'] . setting('sebutan_kecamatan') . ' ' . $desa['nama_kecamatan'] . ' ' . setting('sebutan_kabupaten') . ' ' . $desa['nama_kabupaten'])?></h4>
