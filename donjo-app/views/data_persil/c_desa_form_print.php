						...
						<tr>
							<td class="info">
								<p>Keterangan:<br />
									...
									Sekretariat <?= ucwords(strtolower($ci->setting->sebutan_desa))?> <?= ucwords(strtolower($desa['nama_desa'])) ?>
								</p>
							</td>
							<td>
								<p align="center"> <?= $desa['nama_desa'] ?>, <?= tgl_indo(date('Y m d'))?><br>
									Mengetahui <br>
									KEPALA  <?= strtoupper($ci->setting->sebutan_desa)?> <?= strtoupper($desa['nama_desa']) ?> <br>
									<br>
									<br>
									<br>
									<br>
