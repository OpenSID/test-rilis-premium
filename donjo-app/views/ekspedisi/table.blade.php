							...
							<table class="table table-bordered dataTable table-hover">
								<thead class="bg-gray color-palette">
									<tr>
										...
										<?php if ($o == 8): ?>
											<th><a href="<?= site_url("{$ci->controller}/index/{$p}/7")?>">Tgl Pengiriman <i class='fa fa-sort-asc fa-sm'></i></a></th>
										<?php elseif ($o == 7): ?>
											<th><a href="<?= site_url("{$ci->controller}/index/{$p}/8")?>">Tgl Pengiriman <i class='fa fa-sort-desc fa-sm'></i></a></th>
										<?php else: ?>
											<th><a href="<?= site_url("{$ci->controller}/index/{$p}/7")?>">Tgl Pengiriman <i class='fa fa-sort fa-sm'></i></a></th>
										<?php endif; ?>
										...
										<tr>
											...
											<td class="nostretch">
												...
												<?php if ($data['tanda_terima']): ?>
													<a href='<?= site_url("{$ci->controller}/unduh_tanda_terima/{$data['id']}")?>' class="btn bg-purple btn-flat btn-sm" title="Unduh Tanda Terima" target="_blank"><i class="fa fa-download"></i></a>
												<?php endif; ?>
												<a href="<?= site_url("{$ci->controller}/bukan_ekspedisi/{$p}/{$o}/{$data['id']}")?>" class="btn bg-olive btn-flat btn-sm" title="Keluarkan dari Buku Ekspedisi"><i class="fa fa-undo"></i></a>
											</td>
