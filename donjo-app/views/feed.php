<rss version="2.0"
    ...
    <channel>
        ...
        <description>Situs Web <?= ucwords(setting('sebutan_desa') . ' ' . $data_config['nama_desa'] . ' ' . setting('sebutan_kecamatan_singkat') . ' ' . $data_config['nama_kecamatan'] . ' ' . setting('sebutan_kabupaten_singkat') . ' ' . $data_config['nama_kabupaten'] . ' Prov. ' . $data_config['nama_propinsi']); ?>.</description>
