<rss version="2.0"
	...
	<channel>
		...
		<description>Situs Web <?= ucwords($ci->setting->sebutan_desa . ' ' . $data_config['nama_desa'] . ' ' . $ci->setting->sebutan_kecamatan_singkat . ' ' . $data_config['nama_kecamatan'] . ' ' . $ci->setting->sebutan_kabupaten_singkat . ' ' . $data_config['nama_kabupaten'] . ' Prov. ' . $data_config['nama_propinsi']); ?>.</description>
		<dc:language>id</dc:language>
		<dc:rights>Copyright 2016-<?= date('Y') ?> OpenDESA - OpenSID <?= $ci->setting->current_version ?></dc:rights>
