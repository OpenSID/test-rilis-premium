                ...
                <div class="row">
                    <div class="col-sm-4 col-sm-offset-4 form-box">
                        <div class="form-top">
                            <a href="<?= site_url() ?>">
                                ...
                                <img src="<?= asset('assets/images/bsre.png?v', false) ?>" alt="Bsre"
                                    class="img-responsive" style="width: 185px;" />
                                <?php endif ?>
                            </a>
                            <div class="login-footer-top">
                                ...
                                <h3>
                                    ...
                                    <br /><?= ucwords($ci->setting->sebutan_kecamatan) ?>
                                    <?= $header['nama_kecamatan'] ?><br /><?= ucwords($ci->setting->sebutan_kabupaten) ?>
                                    <?= $header['nama_kabupaten'] ?>
                                </h3>
                            </div>
                        ...
                        <div class="form-bottom">
                            <form id="validasi" class="login-form" action="<?= $form_action ?>" method="post">
                                ...
                                <div class="form-group">
                                    <input name="username" type="text" placeholder="Nama pengguna"
                                        <?php jecho($ci->session->siteman_wait, 1, 'disabled'); ?> value="" class="form-username form-control required">
                                </div>
                                <div class="form-group">
                                    <input name="password" id="password" type="password" placeholder="Kata sandi"
                                        <?php jecho($ci->session->siteman_wait, 1, 'disabled'); ?> value="" class="form-username form-control required">
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" id="checkbox" class="form-checkbox"> Tampilkan kata sandi
                                    <a href="<?= site_url('siteman/lupa_sandi') ?>" class="btn" role="button"
                                        aria-pressed="true">Lupa Kata Sandi?</a>
                                </div>
                                <hr />
                                <div class="form-group">
                                ...
                                <div class="error">
                                    <p style="color:red; text-transform:uppercase">Login Gagal.<br />Nama pengguna atau
                                        kata sandi yang Anda masukkan salah!<br />
                            ...
                            <hr />
                            <div class="login-footer-bottom"><a href="https://github.com/OpenSID/OpenSID"
                                    target="_blank">OpenSID</a> <?= AmbilVersi() ?></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        function start_countdown() {
            ...
            timer = setInterval(function() {
                ...
                if (menit <= 0 && detik <= 0) {
                    ...
                    document.getElementById("countdown").innerHTML = "<b>Gagal 3 kali silakan coba kembali dalam " +
                        menit + " MENIT " + detik + " DETIK </b>";
                }
            }, 1000)
        }
