					...
					<div class="col-md-3">
						<?php if (in_array('sistem', $kategori)) : ?>
							<div class="box box-primary">
								...
								<div class="box-body box-profile text-center">
									<img class="img-responsive" src="<?= asset($latar_website ?: 'front/css/images/latar_website.jpg?v', false); ?>" alt="Latar Halaman Website" width="100%">
							...
							<div class="box box-primary">
								...
								<div class="box-body box-profile text-center">
									<img class="img-responsive" src="<?= asset($latar_login ?: 'css/images/latar_login.jpg?v', false); ?>" alt="Latar Halaman Login" width="100%">
						...
						<?php if (in_array('setting_mandiri', $kategori)) : ?>
							<div class="box box-primary">
								...
								<div class="box-body box-profile text-center">
									<img class="img-responsive" src="<?= asset($latar_login_mandiri ?: 'css/images/latar_login_mandiri.jpg?v', false); ?>" alt="Latar Halaman Login" width="100%">
									<p class="text-muted text-center text-red">(Kosongkan, jika latar login tidak berubah)</p>
									<div class="input-group">
