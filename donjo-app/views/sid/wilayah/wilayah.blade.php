...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Wilayah Administratif <?= ucwords($ci->setting->sebutan_dusun) ?></h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('hom_sid')?>"><i class="fa fa-home"></i> Home</a></li>
			<li class="active">Daftar <?= ucwords($ci->setting->sebutan_dusun) ?></li>
		</ol>
	</section>
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						...
						<a href="<?= site_url("{$ci->controller}/dialog/unduh")?>" title="Unduh Data" class="btn btn-social btn-flat bg-navy btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Unduh Data" data-remote="false" data-toggle="modal" data-target="#modalBox" data-title="Unduh Data"><i class="fa fa-download"></i> Unduh</a>
													...
													<table class="table table-bordered table-striped dataTable table-hover">
														<thead class="bg-gray disabled color-palette">
															<tr>
																...
																<th width="25%"> <?= ucwords($ci->setting->sebutan_dusun) ?></th>
																<th width="35%">Kepala <?= ucwords($ci->setting->sebutan_dusun) ?></th>
																<th>RW</th>
																<th>RT</th>
																<th>KK</th>
																<th>L+P</th>
																...
																<td nowrap>
																	...
																	<div class="btn-group">
																		...
																		<ul class="dropdown-menu" role="menu">
																			<li>
																				<a href="<?= site_url("sid_core/ajax_kantor_dusun_maps/{$data['id']}")?>" class="btn btn-social btn-flat btn-block btn-sm"><i class='fa fa-map-marker'></i> Lokasi Kantor <?=ucwords($ci->setting->sebutan_dusun)?></a>
																			</li>
																			<li>
																				<a href="<?= site_url("sid_core/ajax_wilayah_dusun_maps/{$data['id']}")?>" class="btn btn-social btn-flat btn-block btn-sm"><i class='fa fa-map'></i> Peta Wilayah <?=ucwords($ci->setting->sebutan_dusun)?></a>
																			</li>
																		</ul>
																	</div>
																</td>
