...
<div class="text-center">
	...
	<h4><?= strtoupper($ci->setting->sebutan_desa) ?> <?= strtoupper($config['nama_desa']) ?> <?= strtoupper($ci->setting->sebutan_kecamatan) ?> <?= strtoupper($config['nama_kecamatan']) ?></h4>
	<h4><?= strtoupper($ci->setting->sebutan_kabupaten) ?> <?= strtoupper($config['nama_kabupaten']) ?></h4>
</div>
<br>
