	...
	<div class="box box-solid">
		...
		<div class="box-body box-line">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input class="form-control bilangan_spasi required <?= jecho($cek_anjungan['keyboard'] == 1, true, 'kbvnumber'); ?>" type="text" name="no_hp_aktif" id="no_hp_aktif" placeholder="Ketik No. HP" maxlength="14" value="<?= $permohonan['no_hp_aktif'] ?? $ci->is_login->telepon; ?>"/>
				</div>
			</div>
		</div>
	</div>
