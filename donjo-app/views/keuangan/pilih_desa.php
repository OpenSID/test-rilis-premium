<script type="text/javascript" src="<?= asset('lib/jquery/js/jquery.validate.min.js') ?>"></script>
<script type="text/javascript" src="<?= asset('js/validasi.js') ?>"></script>
<script type="text/javascript" src="<?= asset('js/script.js') ?>"></script>
<script type="text/javascript" src="<?= asset('lib/localization/messages_id.js') ?>"></script>
<style type="text/css">
	.horizontal {
