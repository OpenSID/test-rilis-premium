...
Route::redirect('bumindes_tanah_desa/clear', 'bumindes_tanah_desa');
Route::redirect('bumindes_inventaris_kekayaan/clear', 'bumindes_inventaris_kekayaan');
Route::redirect('bumindes_penduduk_induk/clear', 'bumindes_penduduk_induk');
Route::redirect('bumindes_penduduk_rekapitulasi/clear', 'bumindes_penduduk_rekapitulasi');
Route::redirect('bumindes_penduduk_ktpkk/clear', 'bumindes_penduduk_ktpkk');
Route::redirect('modul/clear', 'modul');
Route::redirect('qr_code', 'qrcode');
Route::redirect('qrcode/clear', 'qrcode/clear');
