...
class Analisis_statistik_jawaban extends \App\Legacy\Core\Admin_Controller
{
    private $_set_page;
    ...
    public function dusun2($id = '', $par = '')
    {
        ...
        ci_redirect("analisis_statistik_jawaban/subjek_parameter/{$id}/{$par}");
    }
    ...
    public function dusun3($id = '')
    {
        ...
        ci_redirect("analisis_statistik_jawaban/grafik_parameter/{$id}");
    }
    ...
    public function delete($p = 1, $o = 0, $id = '')
    {
        ...
        ci_redirect("analisis_statistik_jawaban/index/{$p}/{$o}");
    }
