...
class Point extends \App\Legacy\Core\Admin_Controller
{
    ...
    public function insert_sub_point($point = '')
    {
        ...
        ci_redirect("point/sub_point/{$point}");
    }
