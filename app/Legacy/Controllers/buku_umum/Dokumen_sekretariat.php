...
namespace App\Legacy\Controllers\buku_umum;
...
class Dokumen_sekretariat extends Admin_Controller
{
    ...
    public function index($kat = 2, $p = 1, $o = 0)
    {
        ...
        ci_redirect("dokumen_sekretariat/peraturan_desa/{$kat}/{$p}/{$o}");
    }
    ...
    public function clear($kat = 2)
    {
        ...
        ci_redirect("dokumen_sekretariat/peraturan_desa/{$kat}");
    }
    ...
    public function search()
    {
        ...
        ci_redirect("dokumen_sekretariat/index/{$kat}");
    }
    ...
    {
        ci_redirect("dokumen/dialog_cetak/{$kat}");
    }

    public function dialog_excel($kat = 1)
    {
        ci_redirect("dokumen/dialog_excel/{$kat}");
    }
