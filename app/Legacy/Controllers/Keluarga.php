...
class Keluarga extends \App\Legacy\Core\Admin_Controller
{
    ...
    public function insert_a()
    {
        ...
        if ($_SESSION['validation_error']) {
            ...
            ci_redirect("{$this->controller}/form_a/1/0/{$id_kk}");
        } else {
            ci_redirect("{$this->controller}/anggota/1/0/{$id_kk}");
        }
    }
    ...
    public function add_anggota($p = 1, $o = 0, $id = 0)
    {
        ...
        ci_redirect("{$this->controller}/anggota/{$p}/{$o}/{$id}");
    }
    ...
    public function update_anggota($p = 1, $o = 0, $id_kk = 0, $id = 0)
    {
        ...
        ci_redirect("{$this->controller}/anggota/{$p}/{$o}/{$id_kk}");
    }
    ...
    public function delete_anggota($p = 1, $o = 0, $kk = 0, $id = 0)
    {
        ...
        ci_redirect("{$this->controller}/anggota/{$p}/{$o}/{$kk}");
    }
    ...
    public function keluarkan_anggota($kk, $id = 0)
    {
        ...
        ci_redirect("{$this->controller}/anggota/1/0/{$kk}");
    }
    ...
    public function pecah_semua($id = 0)
    {
        ...
        ci_redirect("{$this->controller}/clear");
    }
}
