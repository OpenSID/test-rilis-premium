...
class Stunting extends \App\Legacy\Core\Admin_Controller
{
    ...
    public function rekapitulasi_ibu_hamil($kuartal = null, $tahun = null, $id = null)
    {
        ...
        if ($kuartal == null || $tahun == null) {
            ...
            $kuartal = $_kuartal;
            ci_redirect(site_url('stunting/rekapitulasi_ibu_hamil/') . $kuartal . '/' . $tahun);
        }
    ...
    public function rekapitulasi_bulanan_anak($kuartal = null, $tahun = null, $id = null)
    {
        ...
        if ($kuartal == null || $tahun == null) {
            ...
            $kuartal = $_kuartal;
            ci_redirect(site_url('stunting/rekapitulasi_bulanan_anak/') . $kuartal . '/' . $tahun);
        }
    ...
    public function scorecard_konvergensi($kuartal = null, $tahun = null, $id = null)
    {
        ...
        if ($kuartal == null || $tahun == null) {
            ...
            $kuartal = $_kuartal;
            ci_redirect(site_url('stunting/scorecard_konvergensi/') . $kuartal . '/' . $tahun);
        }
