...
class Gallery extends \App\Legacy\Core\Admin_Controller
{
    ...
    public function search($gallery = '')
    {
        ...
        if ($gallery != '') {
            ci_redirect("gallery/sub_gallery/{$gallery}");
        } else {
            ci_redirect('gallery');
        }
    }
    ...
    public function gallery_lock($id = '', $gallery = '')
    {
        ...
        if ($gallery != '') {
            ci_redirect("gallery/sub_gallery/{$gallery}/{$p}");
        } else {
            ci_redirect("gallery/index/{$p}/{$o}");
        }
    }
