...
class Main extends \App\Legacy\Core\CI_Controller
{
    ...
    public function index()
    {
        ...
        if (isset($_SESSION['siteman']) && $_SESSION['siteman'] == 1) {
            ...
            switch ($grup) {
                case 1: ci_redirect('hom_sid');
                    break;

                case 2: ci_redirect('hom_sid');
                    break;

                case 3: ci_redirect('web/clear');
                    break;

                case 4: ci_redirect('web/clear');
                    break;

                default:
                    $modul_awal = $this->grup_model->modul_awal($grup);
                    ci_redirect($modul_awal);
                    break;
            }
