...
class Suplemen extends \App\Legacy\Core\Admin_Controller
{
    ...
    public function filter($filter)
    {
        ...
        ci_redirect("{$this->controller}/rincian/{$id_rincian}");
    }
    ...
    public function clear($id = 0)
    {
        ...
        if ($id) {
            ...
            ci_redirect("{$this->controller}/rincian/{$id}");
        }
    ...
    public function edit_terdata($id)
    {
        ...
        ci_redirect("{$this->controller}/rincian/{$id_suplemen}");
    }
