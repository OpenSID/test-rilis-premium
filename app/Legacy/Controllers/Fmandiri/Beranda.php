...
class Beranda extends Mandiri_Controller
{
    ...
    public function index()
    {
        ...
        if ($inbox) {
            ci_redirect('layanan-mandiri/pesan-masuk');
        } else {
            ci_redirect('layanan-mandiri/permohonan-surat');
        }
    }
    ...
    public function proses_ganti_pin()
    {
        ...
        ci_redirect('layanan-mandiri/ganti-pin');
    }
    ...
    public function pendapat(int $pilihan = 1)
    {
        ...
        ci_redirect('layanan-mandiri/keluar');
    }
}
