...
class Program_bantuan extends \App\Legacy\Core\Admin_Controller
{
    ...
    public function detail_clear($program_id)
    {
        ...
        ci_redirect("program_bantuan/detail/{$program_id}");
    }
    ...
    public function aksi($aksi = '', $program_id = 0)
    {
        ...
        ci_redirect("program_bantuan/form/{$program_id}");
    }
    ...
    public function update($id)
    {
        $this->redirect_hak_akses('u');
        $this->program_bantuan_model->update_program($id);
        ci_redirect("program_bantuan/detail/{$id}");
    }
