...
class Lapak_admin extends \App\Legacy\Core\Admin_Controller
{
    ...
    {
        ci_redirect("{$this->controller}/produk");
    }
    ...
    public function produk()
    {
        ...
        if ($data['navigasi']['jml_pelapak']['aktif'] <= 0) {
            ...
            ci_redirect("{$this->controller}/pelapak");
        }
        ...
        if ($data['navigasi']['jml_kategori']['aktif'] <= 0) {
            ...
            ci_redirect("{$this->controller}/kategori");
        }
