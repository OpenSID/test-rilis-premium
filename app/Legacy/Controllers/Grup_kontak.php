...
class Grup_kontak extends \App\Legacy\Core\Admin_Controller
{
        ...
        if ($this->input->is_ajax_request()) {
            return datatables(GrupKontak::withCount('anggota'))
                ...
                ->addColumn('aksi', static function ($row) {
                    ...
                    $aksi .= '<a href="' . ci_route('grup_kontak.anggota', $row->id_grup) . '" class="btn bg-purple btn-sm"  title="Data Anggota"><i class="fa fa fa-list"></i></a> ';
    ...
    public function anggotaInsert()
    {
        ...
        ci_redirect("grup_kontak/anggota/{$this->request['id_grup']}");
    }
