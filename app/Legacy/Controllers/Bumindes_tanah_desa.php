...
class Bumindes_tanah_desa extends \App\Legacy\Core\Admin_Controller
{
    ...
    public function index()
    {
        if ($this->input->is_ajax_request()) {
            ...
            $order  = $this->tanah_desa_model::ORDER_ABLE[$this->input->get('order[0][column]')];
    ...
    public function clear()
    {
        ...
        ci_redirect('bumindes_tanah_desa');
    }
    ...
    public function add_tanah_desa()
    {
        ...
        if ($this->session->success == -1) {
            ...
            ci_redirect('bumindes_tanah_desa/form');
        } else {
            ci_redirect('bumindes_tanah_desa/clear');
        }
    }
    ...
    public function update_tanah_desa($id)
    {
        ...
        if ($this->session->success == -1) {
            $this->session->dari_internal = true;
            ci_redirect("bumindes_tanah_desa/form/{$id}");
        } else {
            ci_redirect('bumindes_tanah_desa/clear');
        }
    }
