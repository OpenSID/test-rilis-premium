...
class Analisis_respon extends \App\Legacy\Core\Admin_Controller
{
    ...
    public function kuisioner($p = 1, $o = 0, $id = 0, $fs = 0)
    {
        ...
        if ($fs != 0) {
            ci_redirect("analisis_respon/kuisioner/{$p}/{$o}/{$id}");
        }
    ...
    public function perbaharui($p = 1, $o = 0, $id_subjek = 0)
    {
        ...
        ci_redirect("{$this->controller}/kuisioner/{$p}/{$o}/{$id_subjek}");
    }
    ...
    public function update_kuisioner($p = 1, $o = 0, $id = 0)
    {
        ...
        ci_redirect("{$this->controller}/kuisioner/{$p}/{$o}/{$id}");
    }
