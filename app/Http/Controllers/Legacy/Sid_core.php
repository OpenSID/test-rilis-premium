...
class Sid_core extends \App\Core\Admin_Controller
{
    ...
    public function insert_rw($id_dusun = '')
    {
        ...
        ci_redirect("{$this->controller}/sub_rw/{$id_dusun}");
    }
    ...
    public function insert_rt($id_dusun = '', $id_rw = '')
    {
        ...
        ci_redirect("{$this->controller}/sub_rt/{$id_dusun}/{$id_rw}");
    }
    ...
    public function warga($id = '')
    {
        ...
        ci_redirect('penduduk/index/1/0');
    }
    ...
    public function warga_kk($id = '')
    {
        ...
        $_SESSION['dusun']    = $dusun;
        ci_redirect('keluarga/index/1/0');
    }
    ...
    public function urut($tipe = '', $p = 1, $id = 0, $arah = 0, $id_dusun = 0, $id_rw = 0)
    {
        ...
        ci_redirect("{$this->controller}/{$url}");
    }
}
