...
class Penduduk extends \App\Legacy\Core\Admin_Controller
{
    ...
    public function dokumen_insert()
    {
        ...
        ci_redirect("{$this->controller}/dokumen/{$id}");
    }
    ...
    public function delete_dokumen($id_pend = 0, $id = '')
    {
        ...
        ci_redirect("{$this->controller}/dokumen/{$id_pend}");
    }
    ...
    public function insert()
    {
        ...
        if ($_SESSION['success'] == -1) {
            ...
            ci_redirect("{$this->controller}/form");
        } else {
            ci_redirect("{$this->controller}/detail/1/0/{$id}");
        }
    }
    ...
    public function update($p = 1, $o = 0, $id = '')
    {
        ...
        if ($_SESSION['success'] == -1) {
            $_SESSION['dari_internal'] = true;
            ci_redirect("{$this->controller}/form/{$p}/{$o}/{$id}");
        } else {
            ci_redirect("{$this->controller}/detail/1/0/{$id}");
        }
    }
    ...
    public function delete($p = 1, $o = 0, $id = '')
    {
        ...
        ci_redirect("{$this->controller}/index/{$p}/{$o}");
    }
    ...
    public function proses_impor_bip()
    {
        ...
        ci_redirect('penduduk/impor_bip');
    }
    ...
    public function foto_bawaan($id)
    {
        ...
        ci_redirect("penduduk/form/1/0/{$penduduk->id}");
    }
}
