...
class Keuangan_manual extends \App\Legacy\Core\Admin_Controller
{
    ...
    {
        ci_redirect('keuangan_manual/manual_apbdes');
    }
    ...
    public function laporan_manual()
    {
        ...
        if (! empty($data['tahun_anggaran'])) {
            ci_redirect('keuangan_manual/grafik_manual/rincian_realisasi_bidang_manual');
        } else {
