...
class Permohonan_surat_admin extends \App\Core\Admin_Controller
{
                ...
                ->addColumn('aksi', static function ($row) {
                    ...
                    if (can('u')) {
                        if ($row->status == 0) {
                            ...
                            $aksi .= '<a href="' . ci_route('permohonan_surat_admin/periksa', $row->id) . '" class="btn btn-social btn-info btn-flat btn-sm pesan-hover" title="Klik untuk memeriksa" style="width: 170px"><i class="fa fa-spinner"></i>Sedang Diperiksa</a> ';
                        } elseif ($row->status == 2) {
                            ...
                            $aksi .= '<a href="' . ci_route("permohonan_surat_admin/proses/{$row->id}/4") . '" class="btn btn-social bg-orange btn-flat btn-sm pesan-hover" title="Klik jika telah diambil" style="width: 170px"><i class="fa fa-thumbs-o-up"></i>Siap Diambil</a> ';
                        } elseif ($row->status == 4) {
    ...
    public function periksa($id = '')
    {
        ...
        if (! $id || ! $periksa) {
            ci_redirect('permohonan_surat_admin');
        }
