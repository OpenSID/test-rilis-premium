...
class Kategori extends \App\Legacy\Core\Admin_Controller
{
    ...
    public function delete_all($p = 1, $o = 0)
    {
        ...
        ci_redirect("kategori/index/{$p}/{$o}");
    }
    ...
    public function insert_sub_kategori($kategori = '')
    {
        ...
        ci_redirect("kategori/sub_kategori/{$kategori}");
    }
