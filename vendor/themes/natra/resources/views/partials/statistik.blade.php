...
<script type="text/javascript">
    let chart;
    const rawData = Object.values(@json($stat));
...
<div class="box-body">
    <div class="table-responsive">
        <table class="table table-striped">
            ...
            <tbody>
                @php $i=0; $l=0; $p=0; $hide=""; $h=0; $jm1=1; $jm = count($stat ?? []); @endphp
                @foreach ($stat as $data)
                @php $jm1++; if (1): @endphp
                @php $h++; if ($h > 12 AND $jm > 10): $hide="lebih"; @endphp
                @endif
                <tr class="{{ $hide }}">
                    <td class="angka">
                        @if ($jm1 > $jm - 2)
                    ...
                    <td>{{ $data['nama'] }}</td>
                    <td class="angka @if ($jm1 <= $jm - 2 && $data['jumlah'] == 0) nol @endif">{{ $data['jumlah'] }}
                    </td>
                ...
                @php $i += $data['jumlah']; @endphp
                @php $l += $data['laki']; $p += $data['perempuan']; @endphp
                @endif
                @endforeach
            </tbody>
        </table>
