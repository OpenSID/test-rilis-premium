        ...
        <div class="space-y-3">
          ...
          <div class="space-y-1/2 text-sm flex flex-col detail">
            ...
            <span class="pt-2 text-xs font-bold text-gray-500 dark:text-gray-50">
              <i class="fas fa-award mr-1"></i> <?= $pro->pelapak ?? 'Admin'; ?> <i class="fas fa-check text-xs bg-green-500 h-4 w-4 inline-flex items-center justify-center rounded-full text-white"></i></span>
          </div>
        </div>
